...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.setSeedPoint = QtWidgets.QPushButton(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.setSeedPoint.sizePolicy().hasHeightForWidth())
        self.setSeedPoint.setSizePolicy(sizePolicy)
        self.setSeedPoint.setObjectName("setSeedPoint")
        self.gridLayout.addWidget(self.setSeedPoint, 3, 2, 1, 4)
        ...
        self.gridLayout.addWidget(self.timeLbl, 10, 0, 1, 4)
...
"вершину"))
        self.setSeedPoint.setText(_translate("MainWindow", "Установить\n"
"затравочную\n"
"точку"))
