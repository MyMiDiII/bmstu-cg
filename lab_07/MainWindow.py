...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.addSelecterBtn = QtWidgets.QPushButton(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.addSelecterBtn.sizePolicy().hasHeightForWidth())
        self.addSelecterBtn.setSizePolicy(sizePolicy)
        self.addSelecterBtn.setObjectName("addSelecterBtn")
        self.selectersLayout.addWidget(self.addSelecterBtn)
...
"отрезок"))
        ...
        self.addSelecterBtn.setText(_translate("MainWindow", "Задать\n"
"отсекатель"))
